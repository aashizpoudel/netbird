...
type Body struct {
	...
	DerpPeerState *DERPPeerState `protobuf:"bytes,12,opt,name=derpPeerState,proto3" json:"derpPeerState,omitempty"`
}
...
func (x *Body) GetDerpPeerState() *DERPPeerState {
	if x != nil {
		return x.DerpPeerState
	}
	return nil
}
...
type DERPPeerState struct {
	...
	Capable           bool   `protobuf:"varint,2,opt,name=capable,proto3" json:"capable,omitempty"`
	HomeRegionId      int32  `protobuf:"varint,3,opt,name=homeRegionId,proto3" json:"homeRegionId,omitempty"`
	HomeNodeId        string `protobuf:"bytes,4,opt,name=homeNodeId,proto3" json:"homeNodeId,omitempty"`
	HomeNodePublicKey []byte `protobuf:"bytes,5,opt,name=homeNodePublicKey,proto3" json:"homeNodePublicKey,omitempty"`
	Generation        uint64 `protobuf:"varint,6,opt,name=generation,proto3" json:"generation,omitempty"`
}

func (x *DERPPeerState) Reset() {
	*x = DERPPeerState{}
	if protoimpl.UnsafeEnabled {
...
func (x *DERPPeerState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DERPPeerState) ProtoMessage() {}

func (x *DERPPeerState) ProtoReflect() protoreflect.Message {
	mi := &file_signalexchange_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DERPPeerState.ProtoReflect.Descriptor instead.
func (*DERPPeerState) Descriptor() ([]byte, []int) {
	return file_signalexchange_proto_rawDescGZIP(), []int{5}
}

func (x *DERPPeerState) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *DERPPeerState) GetCapable() bool {
	if x != nil {
		return x.Capable
	}
	return false
...
func (x *DERPPeerState) GetHomeRegionId() int32 {
	if x != nil {
...
func (x *DERPPeerState) GetHomeNodeId() string {
	if x != nil {
		return x.HomeNodeId
	}
	return ""
...
func (x *DERPPeerState) GetHomeNodePublicKey() []byte {
	if x != nil {
		return x.HomeNodePublicKey
	}
	return nil
}

func (x *DERPPeerState) GetGeneration() uint64 {
	if x != nil {
		return x.Generation
	}
	return 0
...
var file_signalexchange_proto_rawDesc = []byte{
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x97, 0x05, 0x0a, 0x04, 0x42, 0x6f, 0x64, 0x79, 0x12, 0x2d,
	...
	0x72, 0x76, 0x65, 0x72, 0x49, 0x50, 0x88, 0x01, 0x01, 0x12, 0x43, 0x0a, 0x0d, 0x64, 0x65, 0x72,
	0x70, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1d, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x2e, 0x44, 0x45, 0x52, 0x50, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	0x0d, 0x64, 0x65, 0x72, 0x70, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x52,
	...
	,
...
var file_signalexchange_proto_goTypes = []interface{}{
	...
	(*DERPPeerState)(nil),    // 6: signalexchange.DERPPeerState
}
var file_signalexchange_proto_depIdxs = []int32{
	...
	6, // 4: signalexchange.Body.derpPeerState:type_name -> signalexchange.DERPPeerState
