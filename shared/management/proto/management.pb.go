...
type DERPPriority int32

const (
	DERPPriority_DERP_PRIORITY_UNSPECIFIED          DERPPriority = 0
	DERPPriority_DERP_PRIORITY_AFTER_NETBIRD_RELAY  DERPPriority = 1
	DERPPriority_DERP_PRIORITY_BEFORE_NETBIRD_RELAY DERPPriority = 2
)

// Enum value maps for DERPPriority.
var (
	DERPPriority_name = map[int32]string{
		0: "DERP_PRIORITY_UNSPECIFIED",
		1: "DERP_PRIORITY_AFTER_NETBIRD_RELAY",
		2: "DERP_PRIORITY_BEFORE_NETBIRD_RELAY",
	}
	DERPPriority_value = map[string]int32{
		"DERP_PRIORITY_UNSPECIFIED":          0,
		"DERP_PRIORITY_AFTER_NETBIRD_RELAY":  1,
		"DERP_PRIORITY_BEFORE_NETBIRD_RELAY": 2,
	}
)

func (x DERPPriority) Enum() *DERPPriority {
	p := new(DERPPriority)
	*p = x
	return p
}

func (x DERPPriority) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DERPPriority) Descriptor() protoreflect.EnumDescriptor {
	return file_management_proto_enumTypes[6].Descriptor()
}

func (DERPPriority) Type() protoreflect.EnumType {
	return &file_management_proto_enumTypes[6]
}

func (x DERPPriority) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DERPPriority.Descriptor instead.
func (DERPPriority) EnumDescriptor() ([]byte, []int) {
...
type NetbirdConfig struct {
	...
	Derp   *DERPConfig  `protobuf:"bytes,6,opt,name=derp,proto3" json:"derp,omitempty"`
}
...
func (x *NetbirdConfig) GetDerp() *DERPConfig {
	if x != nil {
		return x.Derp
	}
	return nil
...
type DERPConfig struct {
	...
	Regions         []*DERPRegion        `protobuf:"bytes,2,rep,name=regions,proto3" json:"regions,omitempty"`
	SelectionPolicy *DERPSelectionPolicy `protobuf:"bytes,3,opt,name=selectionPolicy,proto3" json:"selectionPolicy,omitempty"`
	Priority        DERPPriority         `protobuf:"varint,4,opt,name=priority,proto3,enum=management.DERPPriority" json:"priority,omitempty"`
}

func (x *DERPConfig) Reset() {
	*x = DERPConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *DERPConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DERPConfig) ProtoMessage() {}

func (x *DERPConfig) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DERPConfig.ProtoReflect.Descriptor instead.
func (*DERPConfig) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{22}
}

func (x *DERPConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *DERPConfig) GetRegions() []*DERPRegion {
	if x != nil {
		return x.Regions
	}
	return nil
...
func (x *DERPConfig) GetSelectionPolicy() *DERPSelectionPolicy {
	if x != nil {
...
func (x *DERPConfig) GetPriority() DERPPriority {
	if x != nil {
		return x.Priority
	}
	return DERPPriority_DERP_PRIORITY_UNSPECIFIED
}
...
type DERPRegion struct {
	...
	Nodes []*DERPNode `protobuf:"bytes,3,rep,name=nodes,proto3" json:"nodes,omitempty"`
}
...
type DERPNode struct {
	...
	StunOnly  bool   `protobuf:"varint,6,opt,name=stunOnly,proto3" json:"stunOnly,omitempty"`
}
...
func (x *DERPNode) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *DERPNode) GetRegionId() int32 {
	if x != nil {
		return x.RegionId
	}
	return 0
...
func (x *DERPNode) GetStunOnly() bool {
	if x != nil {
		return x.StunOnly
	}
	return false
...
type DERPSelectionPolicy struct {
	...
	AllowedRegionIds  []int32 `protobuf:"varint,1,rep,packed,name=allowedRegionIds,proto3" json:"allowedRegionIds,omitempty"`
	DeniedRegionIds   []int32 `protobuf:"varint,2,rep,packed,name=deniedRegionIds,proto3" json:"deniedRegionIds,omitempty"`
	PreferredRegionId int32   `protobuf:"varint,3,opt,name=preferredRegionId,proto3" json:"preferredRegionId,omitempty"`
	AutoSelect        bool    `protobuf:"varint,4,opt,name=autoSelect,proto3" json:"autoSelect,omitempty"`
}

func (x *DERPSelectionPolicy) Reset() {
	*x = DERPSelectionPolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *DERPSelectionPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DERPSelectionPolicy) ProtoMessage() {}

func (x *DERPSelectionPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DERPSelectionPolicy.ProtoReflect.Descriptor instead.
func (*DERPSelectionPolicy) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{25}
}

func (x *DERPSelectionPolicy) GetAllowedRegionIds() []int32 {
	if x != nil {
		return x.AllowedRegionIds
	}
	return nil
}

func (x *DERPSelectionPolicy) GetDeniedRegionIds() []int32 {
	if x != nil {
		return x.DeniedRegionIds
	}
	return nil
}

func (x *DERPSelectionPolicy) GetPreferredRegionId() int32 {
	if x != nil {
...
func (x *DERPSelectionPolicy) GetAutoSelect() bool {
	if x != nil {
		return x.AutoSelect
	}
	return false
...
var file_management_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xab, 0x02, 0x0a, 0x0d, 0x4e, 0x65, 0x74, 0x62,
	...
	0x66, 0x69, 0x67, 0x52, 0x04, 0x66, 0x6c, 0x6f, 0x77, 0x12, 0x2a, 0x0a, 0x04, 0x64, 0x65, 0x72,
	0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x44, 0x45, 0x52, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x04, 0x64, 0x65, 0x72, 0x70, 0x22, 0x98, 0x01, 0x0a, 0x0a, 0x48, 0x6f, 0x73, 0x74, 0x43, 0x6f,
	...
	,
	...
	,
...
var file_management_proto_goTypes = []interface{}{
	...
	(DERPPriority)(0),                      // 6: management.DERPPriority
	...
	(*DERPConfig)(nil),                     // 31: management.DERPConfig
	(*DERPRegion)(nil),                     // 32: management.DERPRegion
	(*DERPNode)(nil),                       // 33: management.DERPNode
	(*DERPSelectionPolicy)(nil),            // 34: management.DERPSelectionPolicy
	(*FlowConfig)(nil),                     // 35: management.FlowConfig
	(*JWTConfig)(nil),                      // 36: management.JWTConfig
	(*ProtectedHostConfig)(nil),            // 37: management.ProtectedHostConfig
	(*PeerConfig)(nil),                     // 38: management.PeerConfig
	(*AutoUpdateSettings)(nil),             // 39: management.AutoUpdateSettings
	(*NetworkMap)(nil),                     // 40: management.NetworkMap
	(*SSHAuth)(nil),                        // 41: management.SSHAuth
	(*MachineUserIndexes)(nil),             // 42: management.MachineUserIndexes
	(*RemotePeerConfig)(nil),               // 43: management.RemotePeerConfig
	(*SSHConfig)(nil),                      // 44: management.SSHConfig
	(*DeviceAuthorizationFlowRequest)(nil), // 45: management.DeviceAuthorizationFlowRequest
	(*DeviceAuthorizationFlow)(nil),        // 46: management.DeviceAuthorizationFlow
	(*PKCEAuthorizationFlowRequest)(nil),   // 47: management.PKCEAuthorizationFlowRequest
	(*PKCEAuthorizationFlow)(nil),          // 48: management.PKCEAuthorizationFlow
	(*ProviderConfig)(nil),                 // 49: management.ProviderConfig
	(*Route)(nil),                          // 50: management.Route
	(*DNSConfig)(nil),                      // 51: management.DNSConfig
	(*CustomZone)(nil),                     // 52: management.CustomZone
	(*SimpleRecord)(nil),                   // 53: management.SimpleRecord
	(*NameServerGroup)(nil),                // 54: management.NameServerGroup
	(*NameServer)(nil),                     // 55: management.NameServer
	(*FirewallRule)(nil),                   // 56: management.FirewallRule
	(*NetworkAddress)(nil),                 // 57: management.NetworkAddress
	(*Checks)(nil),                         // 58: management.Checks
	(*PortInfo)(nil),                       // 59: management.PortInfo
	(*RouteFirewallRule)(nil),              // 60: management.RouteFirewallRule
	(*ForwardingRule)(nil),                 // 61: management.ForwardingRule
	(*ExposeServiceRequest)(nil),           // 62: management.ExposeServiceRequest
	(*ExposeServiceResponse)(nil),          // 63: management.ExposeServiceResponse
	(*RenewExposeRequest)(nil),             // 64: management.RenewExposeRequest
	(*RenewExposeResponse)(nil),            // 65: management.RenewExposeResponse
	(*StopExposeRequest)(nil),              // 66: management.StopExposeRequest
	(*StopExposeResponse)(nil),             // 67: management.StopExposeResponse
	nil,                                    // 68: management.SSHAuth.MachineUsersEntry
	(*PortInfo_Range)(nil),                 // 69: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	38, // 5: management.SyncResponse.peerConfig:type_name -> management.PeerConfig
	43, // 6: management.SyncResponse.remotePeers:type_name -> management.RemotePeerConfig
	40, // 7: management.SyncResponse.NetworkMap:type_name -> management.NetworkMap
	58, // 8: management.SyncResponse.Checks:type_name -> management.Checks
	70, // 9: management.SyncResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	...
	57, // 13: management.PeerSystemMeta.networkAddresses:type_name -> management.NetworkAddress
	...
	38, // 19: management.LoginResponse.peerConfig:type_name -> management.PeerConfig
	58, // 20: management.LoginResponse.Checks:type_name -> management.Checks
	70, // 21: management.LoginResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	22, // 22: management.ExtendAuthSessionRequest.meta:type_name -> management.PeerSystemMeta
	70, // 23: management.ExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	70, // 24: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	29, // 25: management.NetbirdConfig.stuns:type_name -> management.HostConfig
	37, // 26: management.NetbirdConfig.turns:type_name -> management.ProtectedHostConfig
	...
	35, // 29: management.NetbirdConfig.flow:type_name -> management.FlowConfig
	31, // 30: management.NetbirdConfig.derp:type_name -> management.DERPConfig
	7,  // 31: management.HostConfig.protocol:type_name -> management.HostConfig.Protocol
	32, // 32: management.DERPConfig.regions:type_name -> management.DERPRegion
	34, // 33: management.DERPConfig.selectionPolicy:type_name -> management.DERPSelectionPolicy
	6,  // 34: management.DERPConfig.priority:type_name -> management.DERPPriority
	33, // 35: management.DERPRegion.nodes:type_name -> management.DERPNode
	71, // 36: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	29, // 37: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	44, // 38: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	39, // 39: management.PeerConfig.autoUpdate:type_name -> management.AutoUpdateSettings
	38, // 40: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	43, // 41: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	50, // 42: management.NetworkMap.Routes:type_name -> management.Route
	51, // 43: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	43, // 44: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	56, // 45: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	60, // 46: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	61, // 47: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	41, // 48: management.NetworkMap.sshAuth:type_name -> management.SSHAuth
	68, // 49: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	44, // 50: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	36, // 51: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	8,  // 52: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	49, // 53: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	49, // 54: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	54, // 55: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	52, // 56: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	53, // 57: management.CustomZone.Records:type_name -> management.SimpleRecord
	55, // 58: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	59, // 62: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	69, // 63: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	59, // 66: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	2,  // 67: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	59, // 68: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	59, // 69: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	5,  // 70: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	42, // 71: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	9,  // 72: management.ManagementService.Login:input_type -> management.EncryptedMessage
	9,  // 73: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	27, // 74: management.ManagementService.GetServerKey:input_type -> management.Empty
	27, // 75: management.ManagementService.isHealthy:input_type -> management.Empty
	9,  // 76: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	9,  // 77: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	9,  // 78: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	9,  // 79: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	9,  // 80: management.ManagementService.Job:input_type -> management.EncryptedMessage
	9,  // 81: management.ManagementService.ExtendAuthSession:input_type -> management.EncryptedMessage
	9,  // 82: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	9,  // 83: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	9,  // 84: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	9,  // 85: management.ManagementService.Login:output_type -> management.EncryptedMessage
	9,  // 86: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	26, // 87: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	27, // 88: management.ManagementService.isHealthy:output_type -> management.Empty
	9,  // 89: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	9,  // 90: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	27, // 91: management.ManagementService.SyncMeta:output_type -> management.Empty
	27, // 92: management.ManagementService.Logout:output_type -> management.Empty
	9,  // 93: management.ManagementService.Job:output_type -> management.EncryptedMessage
	9,  // 94: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	9,  // 95: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	9,  // 96: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	9,  // 97: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_management_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DERPSelectionPolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_management_proto_msgTypes[50].OneofWrappers = []interface{}{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
