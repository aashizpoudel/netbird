...
type PeerState struct {
	...
	ConnectionType             string                 `protobuf:"bytes,21,opt,name=connectionType,proto3" json:"connectionType,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type DERPState struct {
	...
	HomeRegionID  int32                  `protobuf:"varint,2,opt,name=homeRegionID,proto3" json:"homeRegionID,omitempty"`
	HomeNodeID    string                 `protobuf:"bytes,3,opt,name=homeNodeID,proto3" json:"homeNodeID,omitempty"`
	Ready         bool                   `protobuf:"varint,4,opt,name=ready,proto3" json:"ready,omitempty"`
	HomeConnected bool                   `protobuf:"varint,5,opt,name=homeConnected,proto3" json:"homeConnected,omitempty"`
	Force         bool                   `protobuf:"varint,6,opt,name=force,proto3" json:"force,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DERPState) Reset() {
	*x = DERPState{}
...
func (x *DERPState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DERPState) ProtoMessage() {}

func (x *DERPState) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DERPState.ProtoReflect.Descriptor instead.
func (*DERPState) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{18}
}

func (x *DERPState) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *DERPState) GetHomeRegionID() int32 {
	if x != nil {
		return x.HomeRegionID
	}
	return 0
}

func (x *DERPState) GetHomeNodeID() string {
	if x != nil {
		return x.HomeNodeID
	}
	return ""
...
func (x *DERPState) GetReady() bool {
	if x != nil {
		return x.Ready
	}
	return false
...
func (x *DERPState) GetHomeConnected() bool {
	if x != nil {
		return x.HomeConnected
	}
	return false
}

func (x *DERPState) GetForce() bool {
	if x != nil {
		return x.Force
	}
	return false
...
type FullStatus struct {
	...
	DerpState               *DERPState             `protobuf:"bytes,11,opt,name=derpState,proto3" json:"derpState,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *FullStatus) GetDerpState() *DERPState {
	if x != nil {
		return x.DerpState
	}
	return nil
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x10mDMManagedFields\x18\x1c \x03(\tR\x10mDMManagedFields\"\xba\x06\n" +
	"\tPeerState\x12\x0e\n" +
	...
	"sshHostKey\x12\x12\n" +
	"\x04ipv6\x18\x14 \x01(\tR\x04ipv6\x12&\n" +
	"\x0econnectionType\x18\x15 \x01(\tR\x0econnectionType\"\x9c\x02\n" +
	...
	"\ttransport\x18\x04 \x01(\tR\ttransport\"\xbb\x01\n" +
	"\tDERPState\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\"\n" +
	"\fhomeRegionID\x18\x02 \x01(\x05R\fhomeRegionID\x12\x1e\n" +
	"\n" +
	"homeNodeID\x18\x03 \x01(\tR\n" +
	"homeNodeID\x12\x14\n" +
	"\x05ready\x18\x04 \x01(\bR\x05ready\x12$\n" +
	"\rhomeConnected\x18\x05 \x01(\bR\rhomeConnected\x12\x14\n" +
	...
	"\tderpState\x18\v \x01(\v2\x11.daemon.DERPStateR\tderpState\"\x15\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*DERPState)(nil),                          // 22: daemon.DERPState
	...
	(*RenameProfileRequest)(nil),               // 65: daemon.RenameProfileRequest
	(*RenameProfileResponse)(nil),              // 66: daemon.RenameProfileResponse
	...
	(*MDMManagedFieldsViolation)(nil),          // 78: daemon.MDMManagedFieldsViolation
...
var file_daemon_proto_depIdxs = []int32{
	...
	22,  // 14: daemon.FullStatus.derpState:type_name -> daemon.DERPState
	...
	65,  // 64: daemon.DaemonService.RenameProfile:input_type -> daemon.RenameProfileRequest
	67,  // 65: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	69,  // 66: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	72,  // 67: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	74,  // 68: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	76,  // 69: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	...
	28,  // 84: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	30,  // 85: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	30,  // 86: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	35,  // 87: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	37,  // 88: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	39,  // 89: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	41,  // 90: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	44,  // 91: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	46,  // 92: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	48,  // 93: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	50,  // 94: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	54,  // 95: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	...
	56,  // 99: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	58,  // 100: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	60,  // 101: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	62,  // 102: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	64,  // 103: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	66,  // 104: daemon.DaemonService.RenameProfile:output_type -> daemon.RenameProfileResponse
	68,  // 105: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	70,  // 106: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	73,  // 107: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	75,  // 108: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	77,  // 109: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	80,  // 110: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	82,  // 111: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	84,  // 112: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	86,  // 113: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	88,  // 114: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	90,  // 115: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	92,  // 116: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
